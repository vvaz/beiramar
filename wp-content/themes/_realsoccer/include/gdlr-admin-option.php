			...
			new gdlr_admin_option( 
				...
				apply_filters('gdlr_admin_option',
					array(
								...
								'body-color' => array(
									...
									'options' => array(
										...
										'body-link-color' => array(
											...
											'type' => 'colorpicker',
											'default' => '#aa4243',
											'selector'=> 'a, #joomsport-container a{ color: #gdlr#; }'
										),			
										'body-link-hover-color' => array(
											'title' => __('Link Hover Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#aa4243',
											'selector'=> 'a:hover, #joomsport-container a:hover, #joomsport-container a:focus{ color: #gdlr#; }'
										),			
										'border-color' => array(
									...
									'options' => array(		
										...
										'button-text-color' => array(
											...
											'selector'=> '.gdlr-button, .gdlr-button:hover, input[type="button"], input[type="submit"], ' . 
												'.gdlr-top-menu > .gdlr-mega-menu .sf-mega a.gdlr-button, #joomsport-container a.btn, #joomsport-container .navbar-nav a.btn, #joomsport-container button.btn, ' . 
												'#joomsport-achv-container a.btn, #joomsport-achv-container .navbar-nav a.btn, #joomsport-achv-container button.btn, ' . 
												'#joomsport-container.jsSliderContainer > .jsmainscroll > button, #joomsport-container.jsSliderContainer > .jsmainscroll > button path { color: #gdlr#; fill: #gdlr#; }'
										),	
										'button-background-color' => array(
											'title' => __('Button Background Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f3f3f3',
											'selector'=> '.gdlr-button, input[type="button"], input[type="submit"], #joomsport-container a.btn, #joomsport-container .navbar-nav a.btn, #joomsport-container button.btn,' . 
												'#joomsport-achv-container a.btn, #joomsport-achv-container .navbar-nav a.btn, #joomsport-achv-container button.btn,' . 
												'#joomsport-container.jsSliderContainer > .jsmainscroll > button { background-color: #gdlr#; }'
										),											
								...
								'portfolio-color' => array(
									...
									'options' => array(
										...
										'pagination-background' => array(
											...
											'type' => 'colorpicker',
											'default' => '#ebebeb',
											'selector'=> '.gdlr-pagination .page-numbers, #joomsport-container .paginationJS > li > a, #joomsport-container .paginationJS > li > span{ background-color: #gdlr#; }'
										),		
										'pagination-text-color' => array(
											'title' => __('Pagination Text Color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#979797',
											'selector'=> '.gdlr-pagination .page-numbers, #joomsport-container .paginationJS > li > a, #joomsport-container .paginationJS > li > span { color: #gdlr#; }'
										),
										'pagination-background-hover' => array(
											...
											'selector'=> '.gdlr-pagination .page-numbers:hover, ' . 
												'.gdlr-pagination .page-numbers.current, #joomsport-container .paginationJS > li.active > a, #joomsport-container .paginationJS > li.active > span, ' . 
												'#joomsport-container .paginationJS > li.active > a:hover, #joomsport-container .paginationJS > li.active > a:focus, #joomsport-container .paginationJS > li > a:hover, ' . 
												'#joomsport-container .paginationJS > li > a:focus { background-color: #gdlr#; }'
										),		
										'pagination-text-color-hover' => array(
											...
											'selector'=> '.gdlr-pagination .page-numbers:hover, ' . 
												'.gdlr-pagination .page-numbers.current, #joomsport-container .paginationJS > li.active > a, #joomsport-container .paginationJS > li.active > span, ' . 
												'#joomsport-container .paginationJS > li.active > a:hover, #joomsport-container .paginationJS > li.active > a:focus, #joomsport-container .paginationJS > li > a:hover, ' . 
												'#joomsport-container .paginationJS > li > a:focus { color: #gdlr#; }'
										),									
									)
								),
						...
						// JOOMSPORT settings
						'joomsport' => array(
							'title' => __('Joomsport', 'gdlr_translate'),
							'icon' => GDLR_PATH . '/include/images/icon-elements-color.png',
							'options' => array(
	
								'joomsport-main-color' => array(
									'title' => __('JoomSport Main Color', 'gdlr_translate'),
									'options' => array(
										'table-head-background-color-main' => array(
											'title' => __('Background color of table head on main content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#373737',
											'selector'=> '#joomsport-container .table-responsive .table > thead > tr > th, #joomsport-container table.jstblevwid tbody > tr > th,' . 
												'#joomsport-container .jsBoxStatDIvFE > thead > tr > th, #joomsport-container #stab_overview table.tblPosition thead > tr > th,'.
												'#joomsport-achv-container .table thead > tr > th, #joomsport-container table.table tbody > tr > th { background-color: #gdlr#; } '
										),
										'table-head-border-color-main' => array(
											'title' => __('Border color of table head on main content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#000000',
											'selector'=> '#joomsport-container .table-responsive .table > thead > tr > th, #joomsport-container table.jstblevwid tbody > tr > th,' . 
												'#joomsport-container .jsBoxStatDIvFE > thead > tr > th, #joomsport-container #stab_overview table.tblPosition thead > tr > th,'.
												'#joomsport-achv-container .table thead > tr > th, #joomsport-container table.table tbody > tr > th { border-color: #gdlr#; } '
										),
										'table-head-text-color-main' => array(
											'title' => __('Text color of table head on main content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '#joomsport-container .table-responsive .table > thead > tr > th, #joomsport-container .table-responsive .table > thead > tr > th > *,' . 
												'#joomsport-container table.jstblevwid tbody > tr > th, #joomsport-container .jsBoxStatDIvFE > thead > tr > th,' . 
												'#joomsport-container #stab_overview table.tblPosition thead > tr > th, #joomsport-achv-container .table thead > tr > th > *,' . 
												'#joomsport-container table.table tbody > tr > th { color: #gdlr#; } '
										),
										'table-body-even-row-background-main' => array(
											'title' => __('Even row background color of table body on main content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ebebeb',
											'selector'=> '#joomsport-container .table-responsive .table > tbody > tr:nth-child(even), #joomsport-container table.jstblevwid tbody > tr:nth-child(even), ' . 
												'#joomsport-container .jsBoxStatDIvFE tbody tr, #joomsport-container #stab_overview table.tblPosition tbody tr,' . 
												'#joomsport-achv-container .table > tbody > tr { background-color: #gdlr#; } '
										),
										'table-body-odd-row-background-main' => array(
											'title' => __('Odd row background color of table body on main content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#E2E2E2',
											'selector'=> '#joomsport-container .table-responsive .table > tbody > tr:nth-child(odd), #joomsport-container table.jstblevwid tbody > tr:nth-child(odd), ' . 
												'#joomsport-container .jsBoxStatDIvFE tbody tr:nth-child(2n), #joomsport-container #stab_overview table.tblPosition tbody tr:nth-child(2n), ' . 
												'#joomsport-achv-container .table > tbody > tr:nth-of-type(odd) { background-color: #gdlr#; } '
										),
										'table-body-border-color-main' => array(
											'title' => __('Border color of table body on main content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#e1e1e1',
											'selector'=> '#joomsport-container .table-responsive .table > tbody > tr > td, #joomsport-container table.jstblevwid tbody > tr > td, ' . 
												'#joomsport-container .jsBoxStatDIvFE tbody > tr > td, #joomsport-container #stab_overview table.tblPosition tbody > tr > td, ' . 
												'#joomsport-achv-container .table tbody > tr > td { border-color: #gdlr#; } '
										),
										'table-body-text-color-main' => array(
											'title' => __('Text color of table body on main content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#808080',
											'selector'=> '#joomsport-container table tr > td, #joomsport-achv-container table tr > td { color: #gdlr#; }'
											),
										'table-body-link-color-main' => array(
											'title' => __('Link color of table body on main content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#aa4243',
											'selector'=> '#joomsport-container .table-responsive .table td a, #joomsport-container table.jstblevwid td a, #joomsport-container .jsBoxStatDIvFE td a,' . 
												'#joomsport-container #stab_overview table.tblPosition td a, #joomsport-achv-container .table td a { color: #gdlr#; }'
										),
										'table-body-link-hover-color-main' => array(
											'title' => __('Link hover color of table body on main content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#B03030',
											'selector'=> '#joomsport-container .table-responsive .table td a:hover, #joomsport-container table.jstblevwid td a:hover, #joomsport-container #stab_overview table.tblPosition td a:hover, ' . 
												'#joomsport-achv-container .table td a:hover, #joomsport-container .jsBoxStatDIvFE td a:hover, #joomsport-container .table-responsive .table td a:focus, ' . 
												'#joomsport-container table.jstblevwid td a:focus, #joomsport-container #stab_overview table.tblPosition td a:focus, #joomsport-achv-container .table td a:focus, ' . 
												'#joomsport-container .jsBoxStatDIvFE td a:focus { color: #gdlr#; }'
										),
										'table-foot-background-color-main' => array(
											'title' => __('Background color of table foot on main content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#aa4243',
											'selector'=> '#joomsport-container .jsBoxStatDIvFE tfoot tr td { background-color: #gdlr#; }'
										),
										'table-foot-border-color-main' => array(
											'title' => __('Border color of table foot on main content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#e1e1e1',
											'selector'=> '#joomsport-container .jsBoxStatDIvFE tfoot tr td, #joomsport-container .jsBoxStatDIvFE tfoot tr { border-color: #gdlr#; } '
										),
										'table-foot-text-color-main' => array(
											'title' => __('Text color of table foot on main content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '#joomsport-container .jsBoxStatDIvFE tfoot tr td { color: #gdlr#; } '
										),
										'table-title-color' => array(
											'title' => __('Text color of table title', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#aa4243',
											'selector'=> '#joomsport-container .jsMatchDivMain .js-mdname .jsrow-matchday-name, #joomsport-container #stab_statistic .jsCreerMatchStath3, #joomsport-container .overviewBlocks h3,' . 
												'#joomsport-container #jsMatchViewID h3 { color: #gdlr#; } '
										),
										'match-result-page-team1-background-color' => array(
											'title' => __('Match results page: background color of team 1', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#373737',
											'selector'=> '#joomsport-container #jsMatchViewID .tabs .jsTeamStat .jstable > .jsColTeamEvents .teamEventGraph > div.jsGray, ' .
												'#joomsport-container #jsMatchViewID .jsmatchHeader .jsScoreDivM > .BigMScore1 { background-color: #gdlr#; } '
										),
										'match-result-page-team2-background-color' => array(
											'title' => __('Match results page: background color of team 2', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#aa4243',
											'selector'=> '#joomsport-container #jsMatchViewID .tabs .jsTeamStat .jstable > .jsColTeamEvents .teamEventGraph > div.jsRed, ' . 
												'#joomsport-container #jsMatchViewID .jsmatchHeader .jsScoreDivM > .BigMScore2 { background-color: #gdlr#; } '
										),
									)
								),
								'joomsport-calendar-color' => array(
									'title' => __('JoomSport Calendar Color', 'gdlr_translate'),
									'options' => array(
										'calendar-games-table-even-row-background' => array(
											'title' => __('Calendar games table even row background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ebebeb',
											'selector'=> '#joomsport-container .jsMatchDivMain div.jstable-row { background-color: #gdlr#; } '
										),
										'calendar-games-table-odd-row-background' => array(
											'title' => __('Calendar games table odd row background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f3f3f3',
											'selector'=> '#joomsport-container .jsMatchDivMain div.jstable-row:nth-child(2n) { background-color: #gdlr#; } '
										),
										'calendar-games-table-text-color' => array(
											'title' => __('Calendar games table text color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#808080',
											'selector'=> '#joomsport-container .jsMatchDivMain .jstable-row, #joomsport-container .jsMatchDivMain .jsMatchDivScore .jsScoreDiv > a { color: #gdlr#; } '
										),
										'calendar-games-table-link-color' => array(
											'title' => __('Calendar games table link color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#aa4243',
											'selector'=> '#joomsport-container .jsMatchDivMain .jstable-row a { color: #gdlr#; } '
										),
										'calendar-games-table-team-player-color' => array(
											'title' => __('Calendar games table team/player name color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#808080',
											'selector'=> '#joomsport-container .jsMatchDivMain .jsDivLineEmbl a { color: #gdlr#; } '
										),
									)
								),
								'joomsport-knockout-color' => array(
									'title' => __('JoomSport Knockout Color', 'gdlr_translate'),
									'options' => array(
										'knockout-row-background' => array(
											'title' => __('Knockout row background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ebebeb',
											'selector'=> '#joomsport-container .drawBracketContainerBE .player, #joomsport-container .jsplayerCart .namePlayerCart .LeftnamePlayerCart { background-color: #gdlr#; }'
										),
										'knockout-score-background' => array(
											'title' => __('Knockout score background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#aa4243',
											'selector'=> '#joomsport-container .drawBracketContainerBE .player div.knockscore,#joomsport-container .jsplayerCart > a:hover .imgPlayerCart { background-color: #gdlr#; }'
										),
										'knockout-border-color' => array(
											'title' => __('Knockout border color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#000000',
											'selector'=> '#joomsport-container .drawBracketContainerBE .player, #joomsport-container .drawBracketContainerBE .player div.knockscore, #joomsport-container .drawBracketContainerBE .jsborderI, #joomsport-container .drawBracketContainerBE .jsborderIFin { border-color: #gdlr# !important; }'
										),
										'knockout-text-color' => array(
											'title' => __('Knockout text color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#808080',
											'selector'=> '#joomsport-container .drawBracketContainerBE .player, #joomsport-container .jsplayerCart .namePlayerCart .PlayerCardPos { color: #gdlr#; }'
										),
										'knockout-row-link-color' => array(
											'title' => __('Knockout row link color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#aa4243',
											'selector'=> '#joomsport-container .drawBracketContainerBE .player .knockplName a, #joomsport-container .jsplayerCart .namePlayerCart .js_div_particName { color: #gdlr#; }'
										),
										'knockout-score-link-color' => array(
											'title' => __('Knockout score link color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '#joomsport-container .drawBracketContainerBE .knockscore a, #joomsport-container #stab_players .jsplayerCart .namePlayerCart .PlayerCardPlNumber { color: #gdlr#; }'
										),
									)
								),
								'joomsport-widget-shortcode-color' => array(
									'title' => __('JoomSport Widget Color', 'gdlr_translate'),
									'options' => array(
										'widget-table-head-background-color' => array(
											'title' => __('Widget background color of table head', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#212121',
											'selector'=> '.widget #joomsport-container .table-responsive .table > thead > tr > th, .widget #joomsport-container table.jstblevwid tbody > tr > th { background-color: #gdlr#; }'
										),
										'widget-table-head-border-color' => array(
											'title' => __('Widget border color of table head', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#000000',
											'selector'=> '.widget #joomsport-container .table-responsive .table > thead > tr > th, .widget #joomsport-container table.jstblevwid tbody > tr > th { border-color: #gdlr#; }'
										),
										'widget-table-head-text-color' => array(
											'title' => __('Widget text color of table head', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.widget #joomsport-container .table-responsive .table > thead > tr > th, .widget #joomsport-container table.jstblevwid tbody > tr > th,' . 
											'.widget #joomsport-container .table-responsive .table > thead > tr > th > * { color: #gdlr#; }'
										),
										'widget-table-body-even-row-background' => array(
											'title' => __('Widget even row background color of table body', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ebebeb',
											'selector'=> '.widget #joomsport-container .table-responsive .table > tbody > tr:nth-child(even), .widget #joomsport-container table.jstblevwid tbody > tr:nth-child(even) { background-color: #gdlr#; }'
										),
										'widget-table-body-odd-row-background' => array(
											'title' => __('Widget odd row background color of table body on main content', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#e2e2e2',
											'selector'=> '.widget #joomsport-container .table-responsive .table > tbody > tr:nth-child(odd), .widget #joomsport-container table.jstblevwid tbody > tr:nth-child(odd) { background-color: #gdlr#; } '
										),
										'widget-table-body-border-color' => array(
											'title' => __('Widget border color of table body', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#e1e1e1',
											'selector'=> '.widget #joomsport-container .table-responsive .table > tbody > tr > td, .widget #joomsport-container table.jstblevwid tbody > tr > td { border-color: #gdlr#; }'
										),
										'widget-table-body-text-color' => array(
											'title' => __('Widget text color of table body', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#808080',
											'selector'=> '.widget #joomsport-container table tr > td { color: #gdlr#; }'
										),
										'widget-table-body-link-color' => array(
											'title' => __('Widget link color of table body', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#aa4243',
											'selector'=> '.widget  #joomsport-container .table-responsive .table td a, .widget #joomsport-container table.jstblevwid td a { color: #gdlr#; }'
										),
										'widget-table-body-link-hover-color' => array(
											'title' => __('Widget link hover color of table body', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#B03030',
											'selector'=> '.widget #joomsport-container .table-responsive .table td a:hover, .widget #joomsport-container table.jstblevwid td a:hover, .widget #joomsport-container .table-responsive .table td a:focus, .widget #joomsport-container table.jstblevwid td a:focus { color: #gdlr#; }'
										),
										'match-result-widget-shortcode-background-color' => array(
											'title' => __('Match result widget/shortcode background color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f3f3f3',
											'selector'=> '#joomsport-container.jsSliderContainer > .jsmainscroll > div, #joomsport-container.jsDefaultContainer > .jsmainscroll > div, ' . 
											'.widget #joomsport-container.jsSliderContainer > .jsmainscroll > div, ' . 
											' .widget #joomsport-container.jsDefaultContainer > .jsmainscroll > div { background-color: #gdlr#; } '
										),
										'match-result-widget-shortcode-border-color' => array(
											'title' => __('Match result widget/shortcode border color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#e1e1e1',
											'selector'=> '#joomsport-container.jsSliderContainer > .jsmainscroll > div, #joomsport-container.jsDefaultContainer > .jsmainscroll > div,' .
											'.widget #joomsport-container.jsSliderContainer > .jsmainscroll > div, .widget #joomsport-container.jsDefaultContainer > .jsmainscroll > div' . 
											'#joomsport-container.jsSliderContainer > .jsmainscroll table.jsMNS tr, #joomsport-container .jsview2 .jsmatchcont tr:nth-child(3n)  { border-color: #gdlr#; } '
										),
										'match-result-widget-shortcode-link-color' => array(
											'title' => __('Match result widget/shortcode link color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#aa4243',
											'selector'=> '#joomsport-container table td .js_div_particName > a { color: #gdlr#; } '
										),
										'match-result-widget-shortcode-link-hover-color' => array(
											'title' => __('Match result widget/shortcode link hover color', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#B03030',
											'selector'=> '#joomsport-container table td .js_div_particName > a:hover, #joomsport-container table td .js_div_particName > a:focus { color: #gdlr#; } '
										),
										'match-result-widget-shortcode-score-color-table' => array(
											'title' => __('Match result widget/shortcode score color in table', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#000000',
											'selector'=> '#joomsport-container.jsSliderContainer > .jsmainscroll .jscaruselcont.jsview2 table td.jsvalignmdl a, #joomsport-container.jsDefaultContainer > .jsmainscroll .jscaruselcont.jsview2 table td.jsvalignmdl a { color: #gdlr#; }'
										),
										'match-result-widget-shortcode-score-background-scroll' => array(
											'title' => __('Match result widget/shortcode score bacground color in scroll', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#373737',
											'selector'=> '#joomsport-container.jsSliderContainer > .jsmainscroll table.jsMNS .scoreScrMod { background-color: #gdlr#; } '
										),
										'match-result-widget-shortcode-score-color-scroll' => array(
											'title' => __('Match result widget/shortcode score color in scroll', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '#joomsport-container.jsSliderContainer > .jsmainscroll table.jsMNS .scoreScrMod { color: #gdlr#; } '
										),
									)				
								),						
							)
