	...
	<div class="gdlr-standard-style">
		...
		<div class="blog-content-wrapper" >
			<header class="post-header">
				<?php if( is_single() ){ ?>
					<h1 class="gdlr-blog-title entry-title"><?php the_title(); ?></h1>
				<?php }else{ ?>
					<h3 class="gdlr-blog-title entry-title"><a href="<?php echo get_permalink(); ?>"><?php the_title(); ?></a></h3>
				<?php } ?>	
				
				<?php 
					// print blog information
					if( (is_single() && get_post_type() == 'post') || is_attachment() ){ 
						echo gdlr_get_blog_info(array('date', 'author', 'category', 'comment')); 
					}else if( !is_single() ){
