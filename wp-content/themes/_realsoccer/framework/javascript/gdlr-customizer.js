...
{name: "body-link-color", selector: "a, #joomsport-container a{ color: #gdlr#; }"},
{name: "body-link-hover-color", selector: "a:hover, #joomsport-container a:hover, #joomsport-container a:focus{ color: #gdlr#; }"},
...
{name: "button-text-color", selector: ".gdlr-button, .gdlr-button:hover, input[type=\"button\"], input[type=\"submit\"], .gdlr-top-menu > .gdlr-mega-menu .sf-mega a.gdlr-button, #joomsport-container a.btn, #joomsport-container .navbar-nav a.btn, #joomsport-container button.btn, #joomsport-achv-container a.btn, #joomsport-achv-container .navbar-nav a.btn, #joomsport-achv-container button.btn, #joomsport-container.jsSliderContainer > .jsmainscroll > button, #joomsport-container.jsSliderContainer > .jsmainscroll > button path{ color: #gdlr#; fill: #gdlr#; }"},
{name: "button-background-color", selector: ".gdlr-button, input[type=\"button\"], input[type=\"submit\"], #joomsport-container a.btn, #joomsport-container .navbar-nav a.btn, #joomsport-container button.btn, #joomsport-achv-container a.btn, #joomsport-achv-container .navbar-nav a.btn, #joomsport-achv-container button.btn, #joomsport-container.jsSliderContainer > .jsmainscroll > button { background-color: #gdlr#; }"},
...
{name: "pagination-background", selector: ".gdlr-pagination .page-numbers, #joomsport-container .paginationJS > li > a, #joomsport-container .paginationJS > li > span{ background-color: #gdlr#; }"},
{name: "pagination-text-color", selector: ".gdlr-pagination .page-numbers, #joomsport-container .paginationJS > li > a, #joomsport-container .paginationJS > li > span{ color: #gdlr#; }"},
{name: "pagination-background-hover", selector: ".gdlr-pagination .page-numbers:hover, .gdlr-pagination .page-numbers.current, #joomsport-container .paginationJS > li.active > a, #joomsport-container .paginationJS > li.active > span, #joomsport-container .paginationJS > li.active > a:hover, #joomsport-container .paginationJS > li.active > a:focus, #joomsport-container .paginationJS > li > a:hover, #joomsport-container .paginationJS > li > a:focus{ background-color: #gdlr#; }"},
{name: "pagination-text-color-hover", selector: ".gdlr-pagination .page-numbers:hover, .gdlr-pagination .page-numbers.current, #joomsport-container .paginationJS > li.active > a, #joomsport-container .paginationJS > li.active > span, #joomsport-container .paginationJS > li.active > a:hover, #joomsport-container .paginationJS > li.active > a:focus, #joomsport-container .paginationJS > li > a:hover, #joomsport-container .paginationJS > li > a:focus{ color: #gdlr#; }"},
...
// JOOMSPORT Settings
{name: "table-head-background-color-main", selector: "#joomsport-container .table-responsive .table > thead > tr > th, #joomsport-container table.jstblevwid tbody > tr > th, #joomsport-container .jsBoxStatDIvFE > thead > tr > th, #joomsport-container #stab_overview table.tblPosition thead > tr > th,#joomsport-achv-container .table thead > tr > th, #joomsport-container table.table tbody > tr > th{ background-color: #gdlr#; }"},
{name: "table-head-border-color-main", selector: "#joomsport-container .table-responsive .table > thead > tr > th, #joomsport-container table.jstblevwid tbody > tr > th, #joomsport-container .jsBoxStatDIvFE > thead > tr > th, #joomsport-container #stab_overview table.tblPosition thead > tr > th,#joomsport-achv-container .table thead > tr > th, #joomsport-container table.table tbody > tr > th{ border-color: #gdlr#; }"},
{name: "table-head-text-color-main", selector: "#joomsport-container .table-responsive .table > thead > tr > th, #joomsport-container .table-responsive .table > thead > tr > th > *, #joomsport-container table.jstblevwid tbody > tr > th, #joomsport-container .jsBoxStatDIvFE > thead > tr > th, #joomsport-container #stab_overview table.tblPosition thead > tr > th,#joomsport-achv-container .table thead > tr > th > *, #joomsport-container table.table tbody > tr > th { color: #gdlr#; }"},
{name: "table-body-even-row-background-main", selector: "#joomsport-container .table-responsive .table > tbody > tr:nth-child(even), #joomsport-container table.jstblevwid tbody > tr:nth-child(even), #joomsport-container .jsBoxStatDIvFE tbody tr, #joomsport-container #stab_overview table.tblPosition tbody tr, #joomsport-achv-container .table > tbody > tr { background-color: #gdlr#; }"},
{name: "table-body-odd-row-background-main", selector: "#joomsport-container .table-responsive .table > tbody > tr:nth-child(odd), #joomsport-container table.jstblevwid tbody > tr:nth-child(odd), #joomsport-container .jsBoxStatDIvFE tbody tr:nth-child(2n), #joomsport-container #stab_overview table.tblPosition tbody tr:nth-child(2n),#joomsport-achv-container .table > tbody > tr:nth-of-type(odd) { background-color: #gdlr#; }"},
{name: "table-body-border-color-main", selector: "#joomsport-container .table-responsive .table > tbody > tr > td, #joomsport-container table.jstblevwid tbody > tr > td, #joomsport-container .jsBoxStatDIvFE tbody > tr > td, #joomsport-container #stab_overview table.tblPosition tbody > tr > td, #joomsport-achv-container .table tbody > tr > td{ border-color: #gdlr#; }"},
{name: "table-body-text-color-main", selector: "#joomsport-container table tr > td, #joomsport-achv-container table tr > td { color: #gdlr#; }"},
{name: "table-body-link-color-main", selector: "#joomsport-container .table-responsive .table td a, #joomsport-container table.jstblevwid td a, #joomsport-container .jsBoxStatDIvFE td a, #joomsport-container #stab_overview table.tblPosition td a, #joomsport-achv-container .table td a { color: #gdlr#; }"},
{name: "table-body-link-hover-color-main", selector: "#joomsport-container .table-responsive .table td a:hover, #joomsport-container table.jstblevwid td a:hover, #joomsport-container #stab_overview table.tblPosition td a:hover, #joomsport-achv-container .table td a:hover, #joomsport-container .jsBoxStatDIvFE td a:hover, #joomsport-container .table-responsive .table td a:focus, #joomsport-container table.jstblevwid td a:focus, #joomsport-container #stab_overview table.tblPosition td a:focus, #joomsport-achv-container .table td a:focus, #joomsport-container .jsBoxStatDIvFE td a:focus { color: #gdlr#; }"},
{name: "table-foot-background-color-main", selector: "#joomsport-container .jsBoxStatDIvFE tfoot tr td { background-color: #gdlr#; }"},
{name: "table-foot-border-color-main", selector: "#joomsport-container .jsBoxStatDIvFE tfoot tr td, #joomsport-container .jsBoxStatDIvFE tfoot tr { border-color: #gdlr#; }"},
{name: "table-foot-text-color-main", selector: "#joomsport-container .jsBoxStatDIvFE tfoot tr td { color: #gdlr#; }"},
{name: "table-title-color", selector: "#joomsport-container .jsMatchDivMain .js-mdname .jsrow-matchday-name, #joomsport-container #stab_statistic .jsCreerMatchStath3, #joomsport-container .overviewBlocks h3, #joomsport-container #jsMatchViewID h3 { color: #gdlr#; }"},
{name: "calendar-games-table-even-row-background", selector: "#joomsport-container .jsMatchDivMain div.jstable-row { background-color: #gdlr#; }"},
{name: "calendar-games-table-odd-row-background", selector: "#joomsport-container .jsMatchDivMain div.jstable-row:nth-child(2n) { background-color: #gdlr#; }"},
{name: "calendar-games-table-link-color", selector: "#joomsport-container .jsMatchDivMain .jstable-row a { color: #gdlr#; }"},
{name: "calendar-games-table-text-color", selector: "#joomsport-container .jsMatchDivMain .jstable-row, #joomsport-container .jsMatchDivMain .jsMatchDivScore .jsScoreDiv > a { color: #gdlr#; }"},
{name: "calendar-games-table-team-player-color", selector: "#joomsport-container .jsMatchDivMain .jsDivLineEmbl a { color: #gdlr#; }"},
{name: "knockout-row-background", selector: "#joomsport-container .drawBracketContainerBE .player, #joomsport-container .namePlayerCart .LeftnamePlayerCart { background-color: #gdlr#; }"},
{name: "knockout-score-background", selector: "#joomsport-container .drawBracketContainerBE .player div.knockscore, #joomsport-container .namePlayerCart { background-color: #gdlr#; }"},
{name: "knockout-border-color", selector: "#joomsport-container .drawBracketContainerBE .player, #joomsport-container .drawBracketContainerBE .player div.knockscore, #joomsport-container .drawBracketContainerBE .jsborderI, #joomsport-container .drawBracketContainerBE .jsborderIFin { border-color: #gdlr#!important; }"},
{name: "knockout-text-color", selector: "#joomsport-container .drawBracketContainerBE .player, #joomsport-container .namePlayerCart .PlayerCardPos { color: #gdlr#; }"},
{name: "knockout-row-link-color", selector: "#joomsport-container .drawBracketContainerBE .player .knockplName a, #joomsport-container .namePlayerCart .js_div_particName > a { color: #gdlr#; }"},
{name: "knockout-score-link-color", selector: "#joomsport-container .drawBracketContainerBE .knockscore a, #joomsport-container .namePlayerCart .PlayerCardPlNumber { color: #gdlr#; }"},
{name: "widget-table-head-background-color", selector: ".widget #joomsport-container .table-responsive .table > thead > tr > th, .widget #joomsport-container table.jstblevwid tbody > tr > th { background-color: #gdlr#; }"},
{name: "widget-table-head-border-color", selector: ".widget #joomsport-container .table-responsive .table > thead > tr > th, .widget #joomsport-container table.jstblevwid tbody > tr > th { border-color: #gdlr#; }"},
{name: "widget-table-head-text-color", selector: ".widget #joomsport-container .table-responsive .table > thead > tr > th, .widget #joomsport-container table.jstblevwid tbody > tr > th, .widget #joomsport-container .table-responsive .table > thead > tr > th > * { color: #gdlr#; }"},
{name: "widget-table-body-even-row-background", selector: ".widget #joomsport-container .table-responsive .table > tbody > tr:nth-child(even), .widget #joomsport-container table.jstblevwid tbody > tr:nth-child(even) { background-color: #gdlr#; }"},
{name: "widget-table-body-odd-row-background", selector: ".widget #joomsport-container .table-responsive .table > tbody > tr:nth-child(odd), .widget #joomsport-container table.jstblevwid tbody > tr:nth-child(odd) { background-color: #gdlr#; }"},
{name: "widget-table-body-border-color", selector: ".widget #joomsport-container .table-responsive .table > tbody > tr > td, .widget #joomsport-container table.jstblevwid tbody > tr > td { border-color: #gdlr#; }"},
{name: "widget-table-body-text-color", selector: ".widget #joomsport-container table tr > td { color: #gdlr#; }"},
{name: "widget-table-body-link-color", selector: ".widget  #joomsport-container .table-responsive .table td a, .widget #joomsport-container table.jstblevwid td a { color: #gdlr#; }"},
{name: "widget-table-body-link-hover-color", selector: ".widget #joomsport-container .table-responsive .table td a:hover, .widget #joomsport-container table.jstblevwid td a:hover, .widget #joomsport-container .table-responsive .table td a:focus, .widget #joomsport-container table.jstblevwid td a:focus { color: #gdlr#; }"},
{name: "match-result-widget-shortcode-background-color", selector: "#joomsport-container.jsSliderContainer > .jsmainscroll > div, #joomsport-container.jsDefaultContainer > .jsmainscroll > div { background-color: #gdlr#; }"},
{name: "match-result-widget-shortcode-border-color", selector: "#joomsport-container.jsSliderContainer > .jsmainscroll > div, #joomsport-container.jsDefaultContainer > .jsmainscroll > div, #joomsport-container.jsSliderContainer > .jsmainscroll table.jsMNS tr, #joomsport-container .jsview2 .jsmatchcont tr:nth-child(3n)  { border-color: #gdlr#; }"},
{name: "match-result-widget-shortcode-link-color", selector: "#joomsport-container table td .js_div_particName > a { color: #gdlr#; }"},
{name: "match-result-widget-shortcode-link-hover-color", selector: "#joomsport-container table td .js_div_particName > a:hover, #joomsport-container table td .js_div_particName > a:focus { color: #gdlr#; }"},
{name: "match-result-widget-shortcode-score-color-table", selector: "#joomsport-container.jsSliderContainer > .jsmainscroll .jscaruselcont.jsview2 table td.jsvalignmdl a, #joomsport-container.jsDefaultContainer > .jsmainscroll .jscaruselcont.jsview2 table td.jsvalignmdl a { color: #gdlr#; }"},
{name: "match-result-widget-shortcode-score-background-scroll", selector: "#joomsport-container.jsSliderContainer > .jsmainscroll table.jsMNS .scoreScrMod { background-color: #gdlr#; }"},
{name: "match-result-widget-shortcode-score-color-scroll", selector: "#joomsport-container.jsSliderContainer > .jsmainscroll table.jsMNS .scoreScrMod { color: #gdlr#; }"},
{name: "match-result-page-team1-background-color", selector: "#joomsport-container #jsMatchViewID .tabs .jsTeamStat .jstable > .jsColTeamEvents .teamEventGraph > div.jsGray, #joomsport-container #jsMatchViewID .jsmatchHeader .jsScoreDivM > .BigMScore1 { background-color: #gdlr#; }"},
{name: "match-result-page-team2-background-color", selector: "#joomsport-container #jsMatchViewID .tabs .jsTeamStat .jstable > .jsColTeamEvents .teamEventGraph > div.jsRed, #joomsport-container #jsMatchViewID .jsmatchHeader .jsScoreDivM > .BigMScore2 { background-color: #gdlr#; }"}
];
