...
class ITSEC_Strong_Passwords_Admin {
	...
	public function initialize_admin() {
		...
		add_settings_section(
			...
			__( 'Enforce Strong Passwords', 'it-l10n-ithemes-security-pro' ),
		...
		add_settings_field(
			...
			__( 'Select Role for Strong Passwords', 'it-l10n-ithemes-security-pro' ),
	...
	public function metabox_strong_passwords_settings() {
		...
		echo '<p>' . __( 'Force users to use strong passwords as rated by the WordPress password meter.', 'it-l10n-ithemes-security-pro' ) . '</p>';
	...
	public function strong_passwords_enabled() {
		...
		$content .= '<label for="itsec_strong_passwords_enabled"> ' . __( 'Enable strong password enforcement.', 'it-l10n-ithemes-security-pro' ) . '</label>';
