...
class ITSEC_Salts_Admin {
	...
	public function metabox_advanced_settings() {
		...
		if ( false === $this->settings ) {
			...
			$content .= '<p>' . __( 'A secret key makes your site harder to hack and access by adding random elements to the password.', 'it-l10n-ithemes-security-pro' ) . '</p>';
			...
			$content .= '<p><strong>' . __( 'Note that enabling this feature will log you out of your WordPress site.', 'it-l10n-ithemes-security-pro' ) . '</strong></p>';
		}
			...
			<form method="post" action="?page=toplevel_page_itsec_advanced&settings-updated=true" class="itsec-form">
				...
				<p class="submit">
					<input type="submit" class="button-primary"
					       value="<?php _e( 'Change WordPress Salts', 'it-l10n-ithemes-security-pro' ); ?>"/>
				</p>
			</form>
