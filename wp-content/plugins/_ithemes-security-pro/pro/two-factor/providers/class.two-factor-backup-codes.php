...
class Two_Factor_Backup_Codes extends Two_Factor_Provider {
	...
	public function user_options( $user ) {
		...
		?>
		<p><?php esc_html_e( 'Each authentication code expires after it is used. This provider is best used as a backup provider and not a primary provider.', 'it-l10n-ithemes-security-pro' ); ?></p>
	...
	public function authentication_page( $user ) {
		...
		?>
		<p><?php esc_html_e( 'Enter a backup verification code.', 'it-l10n-ithemes-security-pro' ); ?></p><br/>
		<p>
