...
class ITSEC_Privilege {
	...
	public function edit_user_profile( $user ) {
		...
		if ( $user->ID != get_current_user_id() && ( ( is_multisite() && current_user_can( 'manage_network_options' ) === true ) || ( is_multisite() === false && current_user_can( $itsec_globals['plugin_access_lvl'] ) ) ) ) {
