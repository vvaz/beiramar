				...
				array(
					'page-layout' => array(
						...
						'options' => array(
								...
								'hide-portfolio-info' => array(
									'title' => __('Hide Portfolio Info' , 'gdlr-portfolio'),
									'type' => 'checkbox',
									'default' => 'disable'
								),		
								'hide-portfolio-description' => array(
									'title' => __('Hide Portfolio Description' , 'gdlr-portfolio'),
									'type' => 'checkbox',
									'default' => 'disable'
								),					
						)
						...
						'options' => array(
							...
							'inside-thumbnail-type' => array(
								...
								'options' => array(
									...
									'video'=> __('Video', 'gdlr-portfolio'),
									'slider'=> __('Slider', 'gdlr-portfolio'),
									'gallery'=> __('Gallery', 'gdlr-portfolio'),
							...
							'inside-gallery-columns' => array(
								'title' => __('Inside Gallery Columns' , 'gdlr-portfolio'),
								'type' => 'combobox',
							...
							'inside-gallery-thumbnail' => array(
								'title' => __('Inside Gallery Thumbnail Size' , 'gdlr-portfolio'),
								'type' => 'combobox',
								'options'=> gdlr_get_thumbnail_list(),
								'wrapper-class' => 'gallery-wrapper inside-thumbnail-type-wrapper'
							),
							'inside-gallery-caption' => array(
								'title' => __('Enable Inside Gallery Caption' , 'gdlr-portfolio'),
								'type' => 'combobox',
